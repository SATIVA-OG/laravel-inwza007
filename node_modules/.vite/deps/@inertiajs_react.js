...
var Y = (r) => P("before", { cancelable: true, detail: { visit: r } });
...
function ee(r, e = new FormData(), t = null) {
  r = r || {};
...
var Ce = (r, e, t, i, n) => {
  ...
  if ((M(e) || i) && !Z(e) && (e = ee(e)), Z(e)) return [a, e];
  let [c, d] = Te(t, a, e, n);
  return [y(c), d];
};
...
var G = class {
  ...
  static clearRememberedStateOnReload() {
    B.isReload() && o.deleteState(o.rememberedState);
  }
  static handleBackForward() {
    if (!B.isBackForward() || !o.hasAnyState()) return false;
  ...
  static handleDefault() {
    typeof window < "u" && s.setUrlHash(window.location.hash), s.set(s.get(), { preserveScroll: true, preserveState: true }).then(() => {
      B.isReload() && g.restore(o.getScrollRegions()), R(s.get());
    });
  }
};
var K = class {
...
var j = class {
  ...
  init({ initialPage: e, resolveComponent: t, swapComponent: i }) {
    s.init({ initialPage: e, resolveComponent: t, swapComponent: i }), G.handle(), w.init(), w.on("missingHistoryItem", () => {
  ...
  visit(e, t = {}) {
    ...
    let c = { ...i, ...n }, d = x.get(c);
    d ? (W(d.inFlight), x.use(d, c)) : (W(true), a.send(V.create(c, s.get())));
  }
  getCached(e, t = {}) {
...
function Ie(r, e, t) {
  ...
  function m() {
    let l = e(""), v2 = { ...l ? { title: `<title inertia="">${l}</title>` } : {} }, _2 = Object.values(i).reduce((S, E) => S.concat(E), []).reduce((S, E) => {
...
var Q = (r) => {
  ...
  t.offsetWidth, rt((c) => {
    let d = (() => f.positionUsing === "translate3d" ? { transition: `all ${n}ms ${a}`, transform: `translate3d(${J(r)}%,0,0)` } : f.positionUsing === "translate" ? { transition: `all ${n}ms ${a}`, transform: `translate(${J(r)}%,0)` } : { marginLeft: `${J(r)}%` })();
...
var Ye = (r) => {
  !r && !C || (Oe(0.3 + 0.5 * Math.random()), Q(1));
};
var Oe = (r) => {
  let e = C;
  if (e === null) return ke();
...
var Ze = (r) => {
  ...
  let t = e.querySelector(f.barSelector), i = r ? "-100" : J(C || 0), n = Ue();
...
var le2 = (0, import_react8.forwardRef)(({ children: u2, as: o2 = "a", data: n = {}, href: s2, method: a = "get", preserveScroll: m = false, preserveState: p2 = null, replace: g2 = false, only: P2 = [], except: y2 = [], headers: l = {}, queryStringArrayFormat: e = "brackets", async: f2 = false, onClick: t = k2, onCancelToken: h = k2, onBefore: T2 = k2, onStart: x2 = k2, onProgress: I2 = k2, onFinish: q2 = k2, onCancel: N = k2, onSuccess: J2 = k2, onError: O2 = k2, prefetch: F2 = false, cacheFor: b2 = 0, ...Q2 }, Y2) => {
  let [z2, V2] = (0, import_react8.useState)(0), D2 = (0, import_react8.useRef)(null);
  ...
  return a !== "get" && (o2 = "button"), (0, import_react8.createElement)(o2, { ...Q2, ...{ a: { href: s2 }, button: { type: "button" } }[o2] || {}, ref: Y2, ...(() => C2.includes("hover") ? i : C2.includes("click") ? S : j2)(), "data-loading": z2 > 0 ? "" : void 0 }, u2);
});
...
function me2(u2, o2) {
  ...
  }, [P2, m]), z2 = (0, import_react9.useCallback)((...i) => {
  ...
  return { data: P2, setData: Q2, isDirty: !(0, import_lodash.default)(P2, a), errors: l, hasErrors: f2, processing: h, progress: x2, wasSuccessful: q2, recentlySuccessful: J2, transform: j2, setDefaults: Y2, reset: z2, setError: V2, clearErrors: D2, submit: b2, get: G2, post: U2, put: $2, patch: w2, delete: C2, cancel: X2 };
}
